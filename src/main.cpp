...
constexpr float DPAD_MOVE_PERCENT = 60.0f;   // D-pad speed (turun dari 100% agar lebih terkontrol)
constexpr float MAX_DRIVE_PERCENT = 55.0f;    // Max stick speed (turun dari 100%, cukup kencang)
constexpr float MAX_TURN_PERCENT = 35.0f;     // Max rotasi (turun dari 45%)
